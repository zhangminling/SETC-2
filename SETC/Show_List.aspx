<%@ Page Title="" Language="C#" MasterPageFile="~/Master2Col.master" AutoEventWireup="true" CodeFile="Show_List.aspx.cs" Inherits="Show_List" %>
...
<br />
<!-- 当前位置 -->
<asp:Label ID="CategoryIDLabel" runat="server" Text="" Visible="false"></asp:Label>
...
<asp:GridView ID="GridView2" runat="server" Width="99%" AutoGenerateColumns="false" CellSpacing="0" CellPadding="4" CssClass="showList">
<Columns>
    <asp:TemplateField ItemStyle-Width="340px" ItemStyle-HorizontalAlign="Center"  ItemStyle-VerticalAlign="Top">
        <ItemTemplate>
            <a href='Show_View.aspx?ID=<%# Eval("ID") %>&c=<%# Eval("Catalog") %>'><img src='<%# Eval("CoverPhotoURL") %>' width="320px" alt="" /></a>
            <p>&nbsp;</p>
        </ItemTemplate>        	        
    </asp:TemplateField>
    <asp:TemplateField ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left">
        <ItemTemplate>
        <h3><a href='Show_View.aspx?ID=<%# Eval("ID") %>&c=<%# Eval("Catalog") %>'><%# Eval("Title") %></a></h3>
