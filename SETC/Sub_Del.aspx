<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Sub_Del.aspx.cs" Inherits="Sub_Del" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="IDSLabel" runat="server" Text="" Visible="false"></asp:Label>
    <div id="CurrentPosition">当前位置：<a href="Cat_Man.aspx">分类管理</a>>><a href="#">删除二级分类</a></div>
    <p>&nbsp;</p>
    <h3 style="color: red">您确定要删除此二级分类吗？一旦删除，将不可恢复哦！</h3>
    <p>&nbsp;</p>
    <div>
            ...
            <div class="col-lg-15">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">删除二级分类</span>
                    </div>
                    <!--Widget Header-->
                        ...
                        <div class="widget-main no-padding">
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SubName" HeaderText="栏目名称" ItemStyle-Width="60" />
