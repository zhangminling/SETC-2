...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="col-lg-12 col-sm-12 col-xs-18"  >
                                    <div class="well with-header">
                                        <div class="header bordered-darkpink">删除标签文章>>当前文章标签为：
...
<asp:CheckBox ID="SelectAllCheckBox" runat="server" Text=" 全选 " AutoPostBack="true" oncheckedchanged="SelectAllCheckBox_CheckedChanged"/>
    &nbsp;&nbsp;<asp:Button ID="ArAddBtn" runat="server" Text="确认删除" class="btn btn-success tooltip-success" /></div>               
...
<Columns>
    ...
    <asp:HyperLinkField DataNavigateUrlFields="ID" 
            ...
            HeaderText="文章标题" ItemStyle-Width="350" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Target="_blank" >
    </asp:HyperLinkField>    
